...
def wsi2hdf5(
    ...
    # Turn off logging to console, too many messages from VIPS
    ...
    with tempfile.TemporaryDirectory(dir="./") as tmp_path:
        ...
        if isinstance(crop, bool):
            ...
            if isinstance(crop, tuple):
                ...
                x0 = max(0, min(x0, wsi.info["width"] - 1)) # >= 0, < width
                y0 = max(0, min(y0, wsi.info["height"] - 1)) # >= 0, < height
        ...
        logging.info(f"WSI2HDF5: ...crop {cx0}, {cy0}, {cw}, {ch}")
